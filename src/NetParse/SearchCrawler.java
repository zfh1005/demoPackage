...
Disallow: /login
	...
	ArrayList< String> errorList= new ArrayList< String>();//error information list
	ArrayList< String> result=new ArrayList< String>(); //Search result
	String startUrl;//start URL
	int maxUrl;//Max URL numbers
	...
	public static void main(String[] args) {
		...
		*/
		...
		SearchCrawler crawler = new SearchCrawler("http://www.cnblogs.com",20000,"java");
